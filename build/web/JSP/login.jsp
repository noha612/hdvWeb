...
<%@page import="service.GoogleService"%>
<%@page import="service.FacebookService"%>
        ...
        <jsp:include page="header.jsp"></jsp:include>
            ...
            <div class="header-promotion">
                <div class="header-promotion-contain">
                    ...
                    <div class="header-promotion-item">
                        <svg style="width: 15px;height: 15px;margin-right: 5px;" xmlns="http://www.w3.org/2000/svg"
                             aria-hidden="true" focusable="false" data-prefix="fas" data-icon="shipping-fast"
                             class="svg-inline--fa fa-shipping-fast fa-w-20" role="img" viewBox="0 0 640 512">
                    ...
                    <div class="header-promotion-item">
                        <svg style="width: 15px;height: 15px;margin-right: 5px;" xmlns="http://www.w3.org/2000/svg"
                             aria-hidden="true" focusable="false" data-prefix="far" data-icon="id-card"
                             class="svg-inline--fa fa-id-card fa-w-18" role="img" viewBox="0 0 576 512">
                        <path fill="currentColor"
                ...
                <div class="login-part-1">
                    <div class="login-part-1-contain">
                        ...
                        <button class="login-now" type="submit" name="submit" value="login" aria-label="Login">
                            ...
                            <svg style="padding:12px;width:25px;height:25px;color:white;" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div>
                        ...
                        <div class="type-of-span">
                            <a class="link-login"
                               href="<%= FacebookService.buildFacebookLoginLink()%>">
                                <button class="login-by-anotherapp">
                                    <span>FACEBOOK</span>
                                    <svg style="width: 20px;height: 50px;margin-right: 20px;margin-top: -2px;margin-left: 20px;"
                                         xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false"
                                         data-prefix="fab" data-icon="facebook" class="svg-inline--fa fa-facebook fa-w-16"
                            ...
                            <a class="link-login" href="<%= GoogleService.buildGoogleLoginLink()%>">
                                <button class="login-by-anotherapp">
                                    <span>GOOGLE</span>
                                    <svg style="width: 20px;height: 50px;margin-right: 20px;margin-top: -2px;margin-left: 20px;"
                                         xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false"
                                         data-prefix="fab" data-icon="google" class="svg-inline--fa fa-google fa-w-16"
                                         role="img" viewBox="0 0 488 512">
                                    <path fill="currentColor"
                            ...
                            <!--                    <a class="link-login" href="http://yahoo.com">
                                                    <button class="login-by-anotherapp">
                                                        ...
                                                        <svg style="width: 20px;height: 50px;margin-right: 20px;margin-top: -2px;margin-left: 20px;"
                                                             xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false"
                                                             data-prefix="fab" data-icon="yahoo" class="svg-inline--fa fa-yahoo fa-w-14" role="img"
                                                             viewBox="0 0 448 512">
                                                            <path fill="currentColor"
            ...
            <div class="register-part-2">
                <div class="register-part-2-contain">
                    ...
                    <div>
                        ...
                        <a href="http://localhost:8080/webserver/aboutMemberShip" target="_blank" class="information-register">Read
                            more about free membership</a>
                        <div>
