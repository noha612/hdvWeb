...
<div style="margin-left: 110px; margin-bottom: 30px" class="container breadcrumb">
    ...
    <div class="breadcrumb-break">/</div>
    <div class="breadcrumb-button-current"><%= product.getName() %>
    </div>
</div>
<%
    if (session.getAttribute("message") != null) {
%>
<h4 style="color: green; margin-left: 137px"><%= session.getAttribute("message") %>
</h4>
<%
    ...
    <div class="body-page-part-2">
        <div class="body-page-2-container">
            <div class="review-items">
                <svg style="width: 16px;height: 16px;" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
                     focusable="false" data-prefix="fas" data-icon="star" class="svg-inline--fa fa-star fa-w-18"
            ...
            <div class="content-item">
                ...
                <div class="name-of-item"><%= product.getName() %>
                </div>
                <span class="cost-of-item" style="color: red;">Price: <%= product.getPrice() %>$</span>
            </div>
            <br>
            <div>
                <div class="about-item">Size: <%= product.getSize()%>
                </div>
                <div class="about-item">Color: <%= product.getColor() %>
                </div>
                <div class="about-item">Description: <%= product.getDescription()%>
                </div>
                <br>
                <div>
                    <form action="cart" method="post">
                        <button class="add-to-bag" type="submit" name="submit" value="addToBag">
                            ...
                            <svg style="padding:12px;width:25px;height:25px;color:white;"
                                 xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false"
                                 data-prefix="fas" data-icon="long-arrow-alt-right"
