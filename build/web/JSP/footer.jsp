<%-- 
    Document   : footer
    Created on : Dec 3, 2019, 9:31:46 AM
    Author     : SA Nice
--%>
    ...
    <div class="sign-up-footer">
        <div class="sign-up-footer-contain">
            ...
            <div class="sign-up-footer-button">
                <button onclick="directRegisterPage()" title="signup-now" type="button">
    ...
    <div class="footer-information">
        <div class="footer-information-contain">
            <div class="vietnam-flag">
                <img src="Images/homePage/2000px-Flag_of_Vietnam.svg.jpg" alt=""/>
            </div>
