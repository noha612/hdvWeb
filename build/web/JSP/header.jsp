    ...
    <div class="header-top">
        <div class="header-top-inner">
            ...
            <div id="informationUser" class="information-user">
                ...
                <svg style="cursor:pointer;padding-left:10px;padding-top:5px;width: 20px;height:20px;color:white;"
                     xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" data-prefix="fas"
                ...
                <div class="dropdown-information">
                    ...
                    <form action="userServlet" method="post" class="dropdown-information-form">
                        <button class="dropdown-information-button" type="submit" name="submit" value="logout">LOGOUT
                        </button>
                    </form>
                </div>
            </div>
        ...
        <div class="header-bottom-inner">
            <form action="home" method="post" style="display: flex">
                <button type="submit" style="display: flex; font-size: 16px">
                    <svg style="cursor:pointer;bottom:20px;position: relative;color:white;height:40px;width:75px"
                         aria-hidden="true" focusable="false" data-prefix="fab" data-icon="atlassian"
                         class="svg-inline--fa fa-atlassian fa-w-16" role="img"
                         xmlns="http://w...content-available-to-author-only...3.org/2000/svg" viewBox="0 0 512 512">
                        <path fill="currentColor"
                              d="M152.2 236.4c-7.7-8.2-19.7-7.7-24.8 2.8L1.6 490.2c-5 10 2.4 21.7 13.4 21.7h175c5.8.1 11-3.2 13.4-8.4 37.9-77.8 15.1-196.3-51.2-267.1zM244.4 8.1c-122.3 193.4-8.5 348.6 65 495.5 2.5 5.1 7.7 8.4 13.4 8.4H497c11.2 0 18.4-11.8 13.4-21.7 0 0-234.5-470.6-240.4-482.3-5.3-10.6-18.8-10.8-25.6.1z"></path>
                    </svg>
            ...
            <div class="header-bottom-inner-search">
                <form class="search-input" action="productServlet" method="post">
                    <button type="submit" name="submit" value="searchProduct" class="search-button">
                        <svg style="cursor:pointer;width:15px;height:15px;color:black;"
                             xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" data-prefix="fas"
                    ...
                    <input style="outline: none" type="text" name="text_search" placeholder="Search"
                           aria-label="search"></input>
                </form>
            </div>
            <form class="cart-icon" action="cart">
                <button class="cart-icon-button" style="<%= checkCart ? "background-color: #0071ae" : "" %>"
                        type="submit">
                    <svg style="height: 25px;width:25px;" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
