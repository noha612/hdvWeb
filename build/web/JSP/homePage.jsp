        ...
        <div class="poster-content">
            ...
            <div class="poster-content-signup">
                <a href="http://localhost:8080/webserver/register" target="_blank" id="sign_up" onclick="SignUp()">
                    ...
                    <svg style="padding:12px;width:25px;height:25px" xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="chapter-content">
                    ...
                    <div class="shopping-now">
                        <button onClick="buyForWomen" title="shopping-now" type="button">
                            ...
                            <svg style="padding:12px;width:25px;height:25px" xmlns="http://www.w3.org/2000/svg"
                                 aria-hidden="true" focusable="false" data-prefix="fas" data-icon="long-arrow-alt-right"
                                 class="svg-inline--fa fa-long-arrow-alt-right fa-w-14" role="img"
                                 viewBox="0 0 448 512">
                                <path fill="currentColor"
            ...
            <div class="shoe-trending-contain">
                <div class="shoe-trending">
                    ...
                    <div class="shoe-trending-like">
                        <svg style="width: 18px;height: 20px;margin-right: 15px;margin-top: 10px"
                             xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" data-prefix="far"
                             data-icon="heart" class="svg-inline--fa fa-heart fa-w-16" role="img" viewBox="0 0 512 512">
                            <path fill="currentColor"
                    ...
                    <div class="shoe-trending-image">
                        <div class="shoe-trending-like">
                            <svg style="width: 18px;height: 20px;margin-right: 15px;margin-top: 10px"
                                 ...
                                 data-prefix="far" data-icon="heart" class="svg-inline--fa fa-heart fa-w-16" role="img"
                                 viewBox="0 0 512 512">
                                <path fill="currentColor"
                                      d="M458.4 64.3C400.6 15.7 311.3 23 256 79.3 200.7 23 111.4 15.6 53.6 64.3-21.6 127.6-10.6 230.8 43 285.5l175.4 178.7c10 10.2 23.4 15.9 37.6 15.9 14.3 0 27.6-5.6 37.6-15.8L469 285.6c53.5-54.7 64.7-157.9-10.6-221.3zm-23.6 187.5L259.4 430.5c-2.4 2.4-4.4 2.4-6.8 0L77.2 251.8c-36.5-37.2-43.9-107.6 7.3-150.7 38.9-32.7 98.9-27.8 136.5 10.5l35 35.7 35-35.7c37.8-38.5 97.8-43.2 136.5-10.6 51.1 43.1 43.5 113.9 7.3 150.8z"/>
                            </svg>
        ...
        <div class="body-page-part-5-container">
            <article class="body-page-part-5-article1">
                ...
                <p>Through sports, we have the power to change lives. Sports keep us fit. They keep us mindful. They
                    bring us together. Athletes inspire us. They help us to get up and get moving. And sporting goods
                    featuring the latest technologies help us beat our personal best. Glazerr is home to the runner, the
                    basketball player, the soccer kid, the fitness enthusiast, the yogi. And even the weekend hiker
                    looking to escape the city. The 3-Stripes are everywhere and anywhere. In sports. In music. On
                    life’s stages. Before the whistle blows, during the race, and at the finish line. We’re here to
                    support creators. To improve their game. To live their lives. And to change the world.</p>
            </article>
            <article class="body-page-part-5-article2">
                <h2>WORKOUT CLOTHES, FOR ANY SPORT</h2>
                <p>Glazerr designs for athletes of all kinds. Creators who love to change the game. People who challenge
                    ...
                    female athletes who play just as hard as the men. We design, innovate and iterate. We test new
                    technologies in action. On the field, the track, the court, and in the pool. We’re inspired by retro
                    workout clothes, creating new streetwear essentials. From NMD to our Firebird tracksuits. From Stan
                    Smith to Superstar. Classic sports models are brought back to life on the streets and the stages
                    around the world.</p>
            </article>
        </div>
    </div>
