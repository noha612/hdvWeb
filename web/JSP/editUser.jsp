        ...
        <div class="register-part-1-contain">
            ...
            <form class="form-register" action="userServlet" method="post">
                ...
                <div class="form-register-input">
                    <input style="margin: 0px; padding: 7.5px 25px" placeholder="USERNAME" name="user_name" disabled
                           type="text" value="<%= user.getUsername()%>"></input>
                </div>
