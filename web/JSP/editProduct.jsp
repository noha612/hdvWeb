    ...
    <div class="box">
        <form action="productServlet" method="post">
            ...
            <div class="row">
                ...
                <div class="row-item">
                    <div class="input-title">PRODUCT SIZE</div>
                    </br>
            ...
            <div class="row">
                ...
                <div class="row-item">
                    <div class="input-title">PRODUCT COLOR</div>
                    </br>
                    <select name="color" class="select-type">
                        <option value="black" <%= product.getColor().equals("black") ? "selected" : "" %> >BLACK
                        </option>
                        <option value="white" <%= product.getColor().equals("white") ? "selected" : "" %> >WHITE
                        </option>
                        ...
                        <option value="green" <%= product.getColor().equals("green") ? "selected" : "" %> >GREEN
                        </option>
            ...
            <div class="btn">
                <button formmethod="post" type="submit" name="submit" value="editProduct" class="add-product">EDIT
                </button>
            </div>
            </br></br>
        </form>
