...
<div class="content">
    <div class="container breadcrumb">
        ...
        <div class="breadcrumb-button-current"><%= session.getAttribute("typeView") %>
        </div>
    </div>
    <div class="container content-title">
        <h1 class="content-title-text"><%= session.getAttribute("typeView") %>
        </h1>
        ...
        <div class="container-product-all">
                    ...
                    <div class="container-product">
                        <div class="product-detail">
                            <div class="container-image">
                                ...
                                <img src="<%= link_image %>" alt="<%= name_product %>" title="<%= name_product %>"
                                     width="100%"/>
                                <div class="product-imformation">
                                    <div class="product-name-text"><%= name_product %>
                                    </div>
                                    <div style="width: 100%">
                                        <div style="width: 40%">
                                            <div class="product-price"><%= price %> $</div>
                                            <div class="amont-color">Size: <%= size %>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="container-button">
                <form class="button-product" action="editProduct">
                    ...
                    <button type="submit">
                        <img style="width: 24px; height: 24px" src="Icons/edit.png" alt="edit product"
                             title="edit product"/>
                    </button>
                </form>
                <div class="button-product">
                    <button class="button-delete" type="submit" value="<%= product.getId() %>">
                        <img style="width: 24px; height: 24px" src="Icons/delete.png" alt="edit product"
                             title="edit product"/>
                    </button>
                </div>
            </div>
